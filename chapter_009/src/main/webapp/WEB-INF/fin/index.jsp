...
<body>
    ...
    <div class="container" id="create" style="width: 30%" hidden>
        ...
        <form method="post">
            ...
            <button class="btn btn-default" type="submit" id="addUser" value="Create user" onclick="return createUser()">Create user</button>
            <button class="btn btn-default" type="button" value="Cancel" onclick="showUsers()">Cancel</button>
        </form>
    </div>
</body>
</html>
